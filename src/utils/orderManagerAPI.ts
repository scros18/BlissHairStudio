// Order Manager - Complete API integration with JSON storage
...
class OrderManagerAPI {
  ...
  private async loadOrders(): Promise<void> {
    try {
      ...
      console.error('⚠️ Failed to load orders from API:', error);
      this.orders = [];
    }
  }
  ...
  async createOrder(
    ...
    try {
      ...
      console.log('✅ Order created and saved to data/orders.json:', order.orderNumber);
      return order;
    } catch (error) {
  ...
  async updateOrderStatus(orderId: string, status: Order['status']): Promise<boolean> {
    try {
      ...
      console.log('✅ Order status updated and saved to data/orders.json:', orderId, status);
      return true;
    } catch (error) {
  ...
  async deleteOrder(orderId: string): Promise<boolean> {
    try {
      ...
      console.log('✅ Order deleted from data/orders.json:', orderId);
      return true;
    } catch (error) {
...
export const orderManagerAPI = new OrderManagerAPI();
